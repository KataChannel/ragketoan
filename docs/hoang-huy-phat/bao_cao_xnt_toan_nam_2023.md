<style>
.xnt-table { width: 100%; border-collapse: collapse; font-family: sans-serif; font-size: 13px; }
.xnt-table th, .xnt-table td { border: 1px solid #ddd; padding: 8px; text-align: center; }
.xnt-table th { background-color: #f2f7ff; color: #333; font-weight: bold; }
.xnt-table .header-group { background-color: #f9f9f9; }
.xnt-table .text-left { text-align: left; }
.xnt-table .text-right { text-align: right; }
.xnt-table .qty-col { background-color: #fffdec; }
.xnt-table .amt-col { color: #444; }
.xnt-table .item-name { color: #003366; font-weight: 500; }
</style>
...
<table class="xnt-table">
  ...
  <tfoot>
    <tr style="background-color: #f8f9fa; font-weight: bold;">
      ...
      <td class="qty-col">-</td>
      <td class="text-right amt-col highlight-amt">113.746.247.959 đ</td>
      <td class="qty-col">-</td>
      <td class="text-right amt-col highlight-amt">11.792.417.058 đ</td>
      <td class="qty-col">-</td>
      <td class="text-right amt-col highlight-amt">120.404.923.649 đ</td>
      <td class="qty-col">-</td>
      <td class="text-right amt-col highlight-amt">20.055.324.704 đ</td>
    </tr>
  </tfoot>
</table>