...
|---|---|
| `Viễn thông`, `Cước dịch vụ`, `Cước điện thoại` | **Nợ 642** (Chi phí quản lý) / **Có 112** (Tiền gửi ngân hàng) |

```python
mask_telecom = df['Diễn giải'].str.contains('Viễn thông|Cước dịch vụ|Cước điện thoại', regex=True, case=False)
...
|---|---|---|---|
| `TP CK` hoặc `TRICH LAI` | **635** | 112 | Chi phí tài chính (lãi vay) |
| `TRA GOC VAY` | **341** | 112 | Trả gốc vay |
| `CHI LAI TK TIEN GUI` | 112 | **515** | Doanh thu tài chính (lãi tiền gửi) |
