# Yêu Cầu Tổng Hợp Dữ Liệu XNT - Huy Vũ 2025

Dưới đây là các thông số đầu vào và yêu cầu nghiệp vụ để chạy báo cáo Xuất-Nhập-Tồn (XNT) cho năm 2025.
...
- **MST:** `5900363291`
- **Năm báo cáo:** `2025`
- **Tồn Đầu Kỳ Năm 2025 (Chuyển tiếp từ 2024):** `31,017,722,278` VNĐ

---

## 🎯 2. Mục Tiêu Khớp Số (Target Matching)

Dữ liệu XNT năm 2025 cần được xây dựng dựa trên:
1.  **Hóa đơn Bán ra:** Khớp với Tờ khai thuế GTGT năm 2025.
...
1.  **Báo cáo giải trình:** `BAO_CAO_GIAI_TRINH_KHOP_SO_2025.md`
2.  **File Excel Chi Tiết:** `XNT_HuyVu_2025.xlsx` (Nằm trong `docs/huyvu/`)
