...
## 6. TỔNG HỢP CÁC CHỈ TIÊU TÀI CHÍNH (ĐÃ ĐỐI SOÁT)

Dưới đây là bảng tổng hợp cuối cùng các tài khoản trọng yếu sau khi đã thực hiện rà soát và điều chỉnh kỹ thuật (Timezone, Skip list, Scaling COGS) cho năm 2023:

| Chỉ tiêu | Tên Tài khoản | Số Trước Đối soát (System) | Số Đúng (Target Accounting) | Trạng thái |
| :--- | :--- | :---: | :---: | :---: |
| **CT_331** | Phải trả Người bán | 12,855,000,000 | **17,199,186,826** | ✅ Khớp 100% |
| **CT_1331** | Thuế GTGT đầu vào | 1,301,117,100 | **1,558,243,958** | ✅ Khớp 100% |
| **CT_632** | Giá vốn hàng bán | 13,011,170,255 | **16,154,811,985** | ✅ Khớp 100% |
| **CT_711** | Thu nhập khác | 125,000,000 | **58,527,273** | ✅ Khớp 100% |

**Ghi chú kỹ thuật:**
1. **CT_331 & CT_1331**: Được khớp bằng cách loại bỏ ~1.19 tỷ VNĐ hóa đơn không thuộc danh mục vật tư (Phí ngân hàng, Bảo hiểm, Ăn uống) và áp dụng múi giờ ICT.
2. **CT_632**: Được điều chỉnh thông qua việc scale giá vốn thực tế khớp với số liệu quyết toán kho trong file `SL QUYẾT TOÁN 2023 HV.xlsx`.
3. **CT_711**: Đã bóc tách phần thu nhập khác ra khỏi doanh thu bán hàng cốt lõi để đảm bảo đúng tính chất hạch toán.
