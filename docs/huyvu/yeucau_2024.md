# Yêu Cầu Tổng Hợp Dữ Liệu XNT - Huy Vũ 2024

Dưới đây là các thông số đầu vào và yêu cầu nghiệp vụ để chạy báo cáo Xuất-Nhập-Tồn (XNT) cho năm 2024.
...
Dữ liệu XNT năm 2024 cần được xây dựng dựa trên:
1.  **Hóa đơn Bán ra:** Khớp với Tờ khai thuế GTGT năm 2024.
...
1.  **Báo cáo giải trình:** `BAO_CAO_GIAI_TRINH_KHOP_SO_2024.md`
2.  **File Excel Chi Tiết:** `XNT_HuyVu_2024.xlsx` (Nằm trong `docs/huyvu/`)
