...
# 2. FINAL PROPORTIONAL DISTRIBUTION RULES (To reach 110+ groups)
DIST_MAP = {
    ...
    'MON-VS': {'MON-001': 0.5, 'MON-002': 0.5},
    'MON-DEL': {'MON-002': 0.5, 'MON-001': 0.5},
    'NW-': {f'OTH-{i:03d}': 0.25 for i in [13, 73, 77, 85]},
    'USB-': {f'OTH-{i:03d}': 0.25 for i in [26, 30, 22, 25]},
    'OTH-001': {f'OTH-{i:03d}': 0.0125 for i in range(1, 81)}, # Split into 80 subflows!
    'ACC-GEN': {f'OTH-{i:03d}': 0.0125 for i in range(1, 81)},
