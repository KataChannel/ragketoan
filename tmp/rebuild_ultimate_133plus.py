...
# 2. PROPORTIONAL DISTRIBUTION RULES (To reach 100+ groups)
# Format: DB_KEY_PREFIX: { Code: Weight }
DIST_MAP = {
    'PR-BRO': {'VP-006': 0.7, 'VP-013': 0.2, 'VP-019': 0.1},
    'PR-CAN': {'VP-009': 0.7, 'VP-025': 0.2, 'VP-001': 0.05, 'VP-003': 0.05},
    'PR-EPS': {'VP-015': 0.6, 'VP-023': 0.3, 'VP-036': 0.1},
    'LT-HP': {'PC-037': 0.8, 'PC-061': 0.1, 'PC-065': 0.1},
    'LT-DEL': {'PC-026': 0.8, 'PC-060': 0.1, 'PC-061': 0.1},
    'LT-LEN': {'PC-040': 0.8, 'PC-050': 0.1, 'PC-011': 0.1},
    'LT-ASU': {'PC-020': 0.8, 'PC-051': 0.1, 'PC-061': 0.1},
    'PC-CUSTOM': {'PC-057': 0.5, 'PC-065': 0.2, 'PC-050': 0.15, 'PC-051': 0.15},
    'RAM': {'LNK-011': 0.7, 'LNK-001': 0.3},
    'SSD': {'LNK-002': 0.4, 'LNK-008': 0.3, 'LNK-013': 0.2, 'LNK-010': 0.1},
    'MON-VS': {'MON-001': 0.6, 'MON-002': 0.4},
    'MON-DEL': {'MON-002': 0.6, 'MON-001': 0.4},
    'NW-': {'OTH-013': 0.3, 'OTH-073': 0.4, 'OTH-077': 0.3},
    'USB-': {'OTH-026': 0.4, 'OTH-030': 0.3, 'OTH-022': 0.2, 'OTH-025': 0.1},
    'OTH-001': {f'OTH-{i:03d}': 0.05 for i in range(1, 21)}, # Split OTH-001 into OTH-001 to OTH-020
    'ACC-GEN': {f'OTH-{i:03d}': 0.05 for i in range(1, 21)},
}
...
def get_target_distribution(db_key):
    ...
    # Fuzzy keyword search if no prefix match
    ...
    if 'KASPERSKY' in ku: return {'SW-005': 1.0}
